...
const SearchIcon = () => {
	...
	return (
		<div className={s.search__icon} style={{cursor: "pointer", position: "relative"}}>
			...
			<input
				style={{ opacity: inputDisplay, transform: viewInput ? "translate(0, 0)" : "translate(-200px, -400px)"}}
			...
			<svg
				...
				fill="none"
				xmlns="http://www.w3.org/2000/svg"
				style={{  display: viewInput ? "block" : "none",  transform: viewInput ? "translate(0, 0)" : "translate(-200px, -400px)"}}
			>
				<path
					fillRule="evenodd"
					clipRule="evenodd"
