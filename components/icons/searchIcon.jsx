  ...
  return (
    ...
    >
      <div className={s.search__icon_img}>
        ...
        {/*</svg>*/}
        {/*:*/}
        {/* style={{ display:  viewInput ? "none" : "block" }} */}
        <div className={s.search__icon_img} style={{ opacity:  viewInput ? "0" : "1" }}>
          <Image
      ...
      <svg
        ...
        xmlns="http://www.w3.org/2000/svg"
        style={{
          visibility: viewInput ? "visible" : "hidden",
          opacity: viewInput ? "1" : "0",
          transform: viewInput
            ? "translate(0, 0)"
            : "translate(-200px, -400px)",
        }}
